...
{
	int a1[] = { 1, 2 };
	same_elem_quick_sort(a1, sizeof(a1)/sizeof(int));
	PrintArray(a1, sizeof(a1)/sizeof(int));
	cout << "\n\n";

	int a2[] = { 2, 1 };
	same_elem_quick_sort(a2, sizeof(a2)/sizeof(int));
	...
	same_elem_quick_sort(a4, sizeof(a4)/sizeof(int));
	PrintArray(a4, sizeof(a4)/sizeof(int));
	cout << "\n\n";

	int a5[] = { 3, 7, 4, 5, 7 };
	same_elem_quick_sort(a5, sizeof(a5)/sizeof(int));
